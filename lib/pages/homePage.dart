...
import 'package:cw1_news_api/pages/allNews.dart';
import 'package:cw1_news_api/pages/articleView.dart';
import 'package:cw1_news_api/pages/categoryNews.dart';
import 'package:cw1_news_api/services/data.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget buildIndicator() => AnimatedSmoothIndicator(
        ...
        effect: const SlideEffect(
            dotWidth: 10, dotHeight: 10, activeDotColor: Colors.blueGrey),
      );
}
